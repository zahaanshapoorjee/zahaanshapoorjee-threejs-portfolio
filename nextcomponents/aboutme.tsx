...
const CameraLogger = () => {
  ...
  initial="hidden"
  animate="visible"
  className="flex flex-col mt-20 items-center justify-center px-20 w-full z-[20] h-full lg:flex-row items-center justify-center px-20 mt-10 w-full z-[20] h-full "
>
